...
namespace PlugAndPlay.WebApi.Util.Security
{
    public class UserManagementService : IUserManagementService
    {
        private readonly PlugAndPlayContext context;
        private readonly IPasswordHasher<string> passwordHasher;

        public UserManagementService(PlugAndPlayContext context, IPasswordHasher<string> passwordHasher)
        {
