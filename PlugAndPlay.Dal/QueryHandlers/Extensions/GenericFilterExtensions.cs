...
namespace PlugAndPlay.Dal.QueryHandlers.Extensions
{
  public static class GenericFilterExtensions
  {
    ...
    #region Ako zatreba...
    public static IQueryable<object> SetForType(this PlugAndPlayContext context, Type t)
    {
      return (IQueryable<object>)context.GetType().GetMethod("Set").MakeGenericMethod(t).Invoke(context, null);
    }
    public static IQueryable<object> Set(this PlugAndPlayContext context, string table)
    {
      var type = context.Model.FindEntityType("PlugAndPlay.Dal.Model." + table).ClrType;
